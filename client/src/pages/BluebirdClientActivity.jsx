...
export default function BluebirdClientActivity() {
  const [form, setForm] = useState({
    student_id: '365',
    start_date: '2017-11-29T14:53:04Z',
    end_date:   '2020-11-30T18:53:04Z',
  });
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch('/api/proxy/bluebirdClientActivity', {
        method: 'POST',
    ...
    <div style={{ padding: '28px 32px', maxWidth: '1200px' }}>
      <div style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
          ...
          <code style={{ fontSize: '13px', color: '#6b7280', fontFamily: 'monospace' }}>api.proctoru.com/api/bluebirdclientActivityReport/</code>
        </div>
        <h1 style={{ fontSize: '22px', fontWeight: '700', color: '#111827', marginBottom: '4px' }}>Bluebird Client Activity Report</h1>
        <p style={{ fontSize: '13px', color: '#6b7280' }}>Returns Bluebird exam activity for a student within a date range.</p>
      </div>
